...
def main():
    ...
    # Create a WordCloud for both artists
    print("")
    print("A wordcloud for both artists will be generated")
    make_wordcloud(artist_lyrics[0][1], lyrics_artist_1, artist_lyrics[1][1], lyrics_artist_2)

    print("")
    print("The program is now constructing a model and will use GridSearch\n"
          "in order to find the best model for the task.\n"
...
def make_wordcloud(name_artist_1, lyrics_artist_1, name_artist_2, lyrics_artist_2):
    ...
    for song in lyrics_artist_1:
        text_artist_1 += " " + song

    for song in lyrics_artist_2:
        text_artist_2 += " " + song
    ...
    text2_dict = bow.loc[name_artist_2].sort_values(ascending=False).to_dict()
